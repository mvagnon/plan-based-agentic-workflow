...
- Architecture and reuse: `0-3`
  - `3`: follows declared architecture, dependency direction, ownership boundaries, and reuse rules.
  ...
  - `0`: architecture violation, duplicated logic, duplicated component pattern, or missed obvious reuse.
