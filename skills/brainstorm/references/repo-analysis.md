...
- expected added/deleted line pressure, likely file impact, and small concessions that could avoid many added lines if the user approves them;
...
- Do not recommend a broad implementation when a user-approved small concession would satisfy the core goal with much less added code.
